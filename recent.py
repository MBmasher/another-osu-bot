...
def return_recent(user, best, number, last_beatmap, show_all):
    ...
    if show_all and best == 2:
        max_repeats = len(play_info)

    if current_number > len(play_info):
    ...
    while repeats < max_repeats:
        ...
        combo = play_info[current_number-1][2+index_adjust][1]
        c50 = play_info[current_number-1][3+index_adjust][1]
        c100 = play_info[current_number-1][4+index_adjust][1]
        c300 = play_info[current_number-1][5+index_adjust][1]
        misses = play_info[current_number-1][6+index_adjust][1]
        ...
        score = play_info[current_number-1][1][1]
        grade = play_info[current_number-1][13+index_adjust][1]
        ...
        if best == 1 or best == 3:
            final_pp = float(play_info[current_number-1][14+index_adjust][1])
    ...
    difficulty_settings = play_info_s + map_text
